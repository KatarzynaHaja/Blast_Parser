...
class GenerateReport:
    ...
    def __init__(self, p, filename):
        """
        To generate report was used jinja (html template) and pdfkit package
        :param p: parserBlast object
        :param filename: name of file where should be save report
        """
        ...
        self.config = pdfkit.configuration(
                            wkhtmltopdf=os.getenv('wkhtmltopdf', os.path.join("wkhtmltopdf", "bin", "wkhtmltopdf.exe")))
